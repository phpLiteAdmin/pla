...
class Minify_CSS_Compressor {
     ...
     * @return string
     */
    public static function process($css, $options = []): string
    {
     ...
     */
    private function __construct(protected array $_options)
    {
    }
     ...
     * @return string
     */
    protected function _process(string $css): string
    {
        $css = str_replace("\r\n", "\n", $css);
     ...
     * @return string
     */
    protected function _selectorsCB($m): string
    {
     ...
     * @return string
     */
    protected function _fontFamilyCB($m): string
    {
