...
$lang = array(
	...
	"help3" => "جدول أم عرض",
	"help3_x" => "Auf der Ãœbersichtseite der Datenbank gibt es eine Liste von Tabellen und Sichten. Da Sichten nur gelesen werden kÃ¶nnen, sind einige Operationen deaktiviert und erscheinen daher auch nicht in der Liste. Wenn Sie eine Sicht Ã¤ndern mÃ¶chten, mÃ¼ssen Sie sie lÃ¶schen und neu mit dem angepassten SELECT Ausdruck anlegen. FÃ¼r mehr Informationen, siehe <a href='http://en.wikipedia.org/wiki/View_(database)' target='_blank'>http://en.wikipedia.org/wiki/View_(database)</a>",
