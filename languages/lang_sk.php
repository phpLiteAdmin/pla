...
$lang = array(
    ...
    "ques_empty" => "Naozaj chcete vyprázdniť tabuľku '%s'?",
    "ques_drop" => "Naozaj chcete odstrániť tabuľku '%s'?",
    "ques_drop_view" => "Naozaj chcete odstrániť zobrazenie '%s'?",
    "ques_del_rows" => "Naozaj chcete odstrániť riadky %s z tabuľky '%s'?",
    "ques_del_db" => "Naozaj chcete odstrániť databázu '%s'?",
    "ques_column_delete" => "Naozaj chcete odstrániť stĺpce %s z tabuľky '%s'?",
    "ques_del_index" => "Naozaj chcete odstrániť index '%s'?",
    "ques_del_trigger" => "Naozaj chcete odstrániť spúšť '%s'?",
